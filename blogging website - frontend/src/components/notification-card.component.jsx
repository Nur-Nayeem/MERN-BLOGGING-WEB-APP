...
import NotificationCommentFild from "./notification-comment-field.component";
...
const NotificationCard = ({ data, index, notificationState }) => {
    ...
    let { userAuth: { username: author_username, profile_img: autor_profile_img, access_token } } = useContext(UserContext);
    ...
    return (
        <div className={"p-6 border-b rounded-lg border-grey " + (!seen ? "bg-grey" : "")}>
            <div className="flex gap-5 mb-3">
                <img src={profile_img} className="w-14 h-14 flex-none rounded-full" />
                <div className="w-full">
                    <h1 className="font-medium text-x1 text-dark-grey">
...

            {
                isReply ?
                    <div className="mt-8">
                        <NotificationCommentFild _id={_id} blog_author={user} index={index} replyingTo={comment._id} setIsReply={setIsReply} notification_id={notification_id} notificationData={notificationState} />
                    </div> : ""
            }
                ...
                reply ?
                    <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
                        <div className="flex gap-3 mb-3">
                            <img src={autor_profile_img} className="w-8 h-8 rounded-full" />
                        ...
                        <p className="ml-14 font-gelasio text-black my-2">{reply.comment}</p>
