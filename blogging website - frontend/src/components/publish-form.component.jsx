...
const PublishForm = () => {
    ...
    const publishBlog = (e) => {
        ...
        if (!title.length) {
            return toast.error("whrite blog title before publishing");
        }
        if (!des.length || des.length > characterLimit) {
            return toast.error(`write a description about your blog, writing at most ${characterLimit} characters to pulish`);
        }
        if (!tags.length) {
        ...
        <Animationwrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16">
                ...
                <div className="border-grey lg:border-1 lg:pl-8 ">
                    ...
                    <p className="mt-1 text-dark-grey text-sm text-right">{characterLimit - des.length} charecter left</p>
