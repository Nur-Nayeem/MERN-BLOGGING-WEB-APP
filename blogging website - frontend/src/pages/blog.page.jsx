    ...
    const fetchBlog = () => {
        axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/get-blog", { blog_id })
            .then(async ({ data: { blog } }) => {
                ...
                axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/search-blogs", { tag: blog.tags[0], limit: 6, eleminate_blog: blog_id })
                    .then(({ data }) => {
                            ...
                            <div className="mt-12">
                                ...
                                <div>
                                    <div className="flex max-sm:flex-col justify-between my-8">
                                        ...
                                        <p className="text-dark-gray opacity-75 max-sm:mt-6 max-sm:ml-12 max-sm:pl-5">Published on {getDay(publishedAt)}</p>
